...
?>
  ...
  <div class="form-group">
      <?php echo zen_draw_label(TEXT_PRODUCTS_BARCODE, 'products_barcode', 'class="col-sm-3 control-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_input_field('products_barcode', htmlspecialchars(stripslashes($pInfo->products_barcode), ENT_COMPAT, CHARSET, TRUE), zen_set_field_length(TABLE_PRODUCTS, 'products_barcode') . ' class="form-control" OnKeyPress="return disableEnterKey(event)"'); ?>
    </div>
  </div>
    <hr>
