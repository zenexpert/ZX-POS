...
define('MODULE_SHIPPING_POSINSTORE_TEXT_TITLE', 'In-store Pickup');
define('MODULE_SHIPPING_POSINSTORE_TEXT_DESCRIPTION', 'Customer In Store Pick-up');
define('MODULE_SHIPPING_POSINSTORE_TEXT_WAY', 'Walk In');
...
// The content of the MODULE_SHIPPING_POSINSTORE_MULTIPLE_WAYS definition should be the same as the multiple locations in the shipping module's settings in your admin, just with names changed.
// Typical formats are:
...
define('MODULE_SHIPPING_POSINSTORE_MULTIPLE_WAYS', "");
