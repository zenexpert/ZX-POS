...
<?php if(isset($_SESSION['POStoken'])) { ?>
	
    <h1>Checkout Success!</h1>
    
	<div id="calculator">
    	<div id="orderTotal">Order Total: <strong><?php echo $currencies->format($order_total, 2); ?></strong></div>
    	<div id="cashIn">Cash given:
        	<form id="cashCalc">
            	<input type="text" size="15" name="cashGiven" id="cashGiven" />
                
                </form></div>
        <div id="cashOut">Cash Return:<span id="cashReturn"></span></div>
    </div>
    
    <div class="clearBoth"></div>
    <a class="myButton" href="posinvoice.php?oID=<?php echo $zv_orders_id; ?>" target="_blank">Print Invoice</a>
    <br />
	<br />
    <a class="myButton" href="<?php echo zen_href_link(FILENAME_LOGOFF, '', 'SSL'); ?>">Return to POS</a>
