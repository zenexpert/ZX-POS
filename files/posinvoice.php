...
<link rel="stylesheet" type="text/css" href="posinvoice.css">
  ...
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="pageHeading" align="right"><?php echo zen_image($template->get_template_dir(HEADER_LOGO_IMAGE, DIR_WS_TEMPLATE, $current_page_base,'images'). '/' . HEADER_LOGO_IMAGE, HEADER_ALT_TEXT); ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
<?php 
	...
	$messageStack->add_session('header', 'You are not authorized for this action.', 'error');
